  ...
  return (
    <main className='min-h-screen bg-[#f6f2ea] text-[#2b1b17]'>
      ...
      <ResourceHero
        ...
        heroImage='/sushruta-surgery.jpg'
        heroImageAlt='Collaborative contribution desk for reviewing sources and educational material'
      />
      ...
      <section className='max-w-7xl mx-auto px-6 md:px-12 py-12 space-y-8'>
        ...
        <ResourceRelatedSection
          title='Contribution Review Lanes'
          description='Different submissions need different handling. This structure helps contributors send the right context so editors can review quickly and responsibly.'
          cards={[
            {
              label: 'Corrections',
              title: 'Fix a claim or date',
              body: 'Send the page URL, the exact sentence, the correction, and a source that supports the change.',
            },
            {
              label: 'Sources',
              title: 'Add a paper or archive',
              body: 'Include publication details, archive links, DOI or catalogue IDs where available, and the topic page where it belongs.',
            },
            {
              label: 'Media',
              title: 'Suggest image or video',
              body: 'Share attribution, usage context, and why the media improves understanding instead of acting as decoration.',
            },
          ]}
          checklist={[
            'Submitting corrections with source support.',
            'Suggesting new research references.',
            'Offering educational videos or diagrams.',
            'Joining as a reviewer, writer, or translator.',
          ]}
        />
        ...
        <section className='grid md:grid-cols-2 gap-5'>
          <article className='border border-[#8d4f36]/20 bg-white p-6'>
            ...
            <div className='mt-3 aspect-video bg-black'>
              <iframe data-skip-global-embed='true' src='https://www.youtube.com/embed?listType=search&list=how%20to%20contribute%20to%20open%20knowledge%20projects' title='Contribution process video' className='h-full w-full' loading='lazy' referrerPolicy='strict-origin-when-cross-origin' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' allowFullScreen />
            </div>
          </article>
          <article className='border border-[#8d4f36]/20 bg-white p-6'>
        ...
        <ResourceImageSupport
          notes={[
            'Use contributor-workflow visuals: source packets, review notes, collaboration boards, and clear submission checklists.',
            'Images should make participation feel organized and credible, not generic contact-page decoration.',
          ]}
          terms={['contribution desk', 'source review', 'corrections', 'peer review', 'editorial inbox', 'collaboration']}
        />
      </section>
      <Footer />
    </main>
